...
<main class="app_container container template-magazine">
    <div class="row">
        ...
        <div class="col col-md-3"><?php get_template_part( 'template-parts/section', 'post', array('class'=>'style2', 'per_page' => 3) ); ?></div>
        <div class="col col-md-3"><?php get_template_part( 'template-parts/section', 'post', array('per_page' => 4)); ?></div>
    </div>
    <div class="row">
        <div class="col">
