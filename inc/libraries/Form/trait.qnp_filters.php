...
trait QNP_Filters
{
     ...
     * @param string $value 
     */
    public static function convertKatakana($str)
    {
        return mb_convert_kana($str, 'KVC', 'UTF-8');
    }
     ...
     * @param string $value 
     */
    public static function convertHankaku($value)
    {
     ...
     * @param string $value 
     */
    public static function convertHiragana($value)
    {
        return mb_convert_kana($value, 'HVc', 'UTF-8');
    }
     ...
     * @param string $value 
     */
    public static function convertHiraganaToKatakana($value)
    {
        $str_array = array(
            /* --- 0x2100 - 0x2138 (文字種記号) --- */
            // 0x2100 - 0x210F
...
//              "\xE2\x98\x86" => "(白星)",
        ...
        $value = str_replace( array_keys($str_array), array_values($str_array), $value);
    ...
    */
     ...
     */
    public function numFull2Half($fullWidth)
    {
        return mb_convert_kana($fullWidth,"n");
    }
     ...
     * @param string $value 
     */
    public function convertDateJa($value)
    {
     ...
     * @param string $value 
     */
    public function convertStr2Dot($value, $dot = '●')
    {
        $value = str_repeat($dot, strlen($value));
        return $value;
    }
}
